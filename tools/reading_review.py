...
def main():
    ...
    with (args.out / "human-review.csv").open("w", encoding="utf-8-sig", newline="") as stream:
        ...
        writer.writerow(["case_id", "reviewer", "role_expert_or_customer", "preferred_A_B_tie", "grounding_1_5", "specificity_1_5", "consistency_1_5", "actionability_1_5", "quoted_price", "would_pay_yes_no", "incorrect_claim_id", "notes", "clarity_1_5", "felt_understood_1_5", "repetitive_passage", "most_personal_passage"])

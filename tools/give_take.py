...
# 손님이 도는 차례.
#
# ★ 손으로 적어 두었더니 자가 거짓말을 했습니다 (2026-09-10)
#
#   여기 박혀 있던 것은 `["a1","a2","a5","a3","a4","a4b","a6","a7"]` 였는데
#   화면 코드는 그 뒤에 바뀌었습니다 — 별칭(a2)과 성향 넉 자(a4b)가 훅
#   **뒤로** 물러나 본길에서 빠졌습니다. 그래서 이 자는 지나지도 않는
#   화면을 세고 「첫 돌려줌은 여섯 번째」 라고 답했습니다. 실제로는
#   다섯 번째(a6)입니다.
#
#   차례는 화면 코드에 이미 있습니다. 읽습니다.
FUNNEL = S.live_path()

...
export const DOUBTS: { q: string; a: string }[] = [
  ...
  },
  {
     ...
     *   (tools/divergence.py). 그때 답이 없으면 그 자리에서 「틀린 집」이
     *   됩니다. 미리 답을 두고, 갈리는 사람에게는 명식 화면에서 **먼저**
     *   말합니다.
     */
    q: "다른 만세력과 다르게 나오면",
    a: "갈리는 자리가 둘 있소. **밤 11시 이후**에 난 사람과 " +
       "**절기가 바뀌는 언저리**에 난 사람이오. 백 명에 넷다섯이 걸리오." +
       "\n\n" +
       "이건 셈이 틀린 게 아니라 **어느 법으로 볼지**를 다르게 고른 " +
       "것이오. 밤 11시를 다음 날로 넘기는 법(조자시)과 그날로 두는 " +
       "법(야자시)이 둘 다 정식이오. 이 집은 조자시로 보고, 절기는 " +
       "진태양시로 고친 시각과 견주오." +
       "\n\n" +

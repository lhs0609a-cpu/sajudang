...
const WHERE: Record<string, { at: string; href: string }> = {
  ...
  door:     { at: "d1b 엿보기 — 접힌 자리", href: "/pay" },
  seat:     { at: "b3 그 사람의 자리", href: "/lobby?tab=b3" },
  shelf:    { at: "b1 진열대", href: "/lobby?tab=b1" },
  scroll:   { at: "c1 두루마리 · c7 분석지", href: "/summary" },
  unbind:   { at: "c2 본문 여는 자리 (리포트)", href: "/lobby" },
  roadmap:  { at: "c3 대운 맵 (리포트)", href: "/lobby" },
  fold:     { at: "c4 페이월 (리포트)", href: "/lobby" },
  cardbg:   { at: "c5 공유 카드 (리포트)", href: "/lobby" },
  wall:     { at: "c6 후기 벽 · r1 다녀간 사람들", href: "/me" },
  oldpaper: { at: "c4 안 파는 자리 · d0 값 없이 한 겹 더", href: "/pay" },
  coin:     { at: "d2 값을 치르다", href: "/pay" },
  untie:    { at: "d3 열렸소", href: "/pay" },
  tray:     { at: "d1 어디까지 볼지", href: "/pay" },
  handle:   { at: "h1 이어지다", href: "/relay" },
  banner:   { at: "g1 오늘의 일진", href: "/daily" },
  tea:      { at: "g1 오늘의 일진 · 다과상", href: "/daily" },
  sealbook: { at: "f2 인장첩", href: "/me" },
};

  ...
  return (
    <Shell screen="f2" title="내 보관함">
      ...
      */}
      ...
      <header className="editorial-heading"><p className="conversion-kicker">구매·보관·복원</p><h1>내가 연 본문과 결제 내역을<br/>여기서 다시 여시오.</h1><p>구매한 캐릭터, 남은 이용권, 열람 기록, 환불 상태를 한곳에서 확인하오.</p></header>

...
function MeInner() {
  ...
  if (tab === "r1") {
    ...
    return (
      ...
      <p className="sm">여기 붙은 말도 여태 혼자 참고 있던 사람들이 적고 간 것이오. 그대도 한 마디 적을 수 있고, 안 적어도 되오.</p>
      {/*
        ★ 비유 66 · 셀 수 있는 값 넷. 여기 붙는 것은 남의 말이라,
          수를 안 대면 「많이들 다녀갔소」 같은 뜬 말이 됩니다.
      */}
      <p className="sm"><mark>남긴 말은 <b>100건</b>이 넘어야 화면에 수로 나오오.</mark> 그 아래는 세어 두기만 하고 안 보이오 — 김치가 익을 때까지 장독을 덮어 두는 것과 같소.</p>
        ...
        */}
        <ActOut kind="남긴 물음" next={heard > 0 ? "남기다" : "스무 사람"}>
          {heard > 0 ? (
            ...
            <>
              이 벽에서 그대 칸은 아직 비어 있소. <b>한 사람도 끝까지 안 들었소.</b><br />
              스물 중 <b>누구부터</b> 들으시겠소?
            </>
          )}
        </ActOut>
      ...
      */}
      <Say who="도령" lens="pungun">
        ...
        */}
        ...
        <br />
        <b>빈 칸을 보면 채우고 싶어지오.</b> 스무 칸이 그려져
        있으면 사람은 다 채우려 드오. 그건 이 첩이 그렇게 생겨서지
        그대에게 스물이 필요해서가 아니오.
        {" "}부담스럽다면 이미 읽은 자리 하나만 다시 보아도 좋소.
        <br />
        칸 1개로 끝나도 되오. 두 칸이 나란히 있다고 둘째까지 들어야 하는

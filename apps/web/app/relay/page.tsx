  ...
  return (
    <Shell screen="h1" title="이어지다" legal>
      ...
      */}
      ...
      <p className="sm">여태 한 사람 말만 듣고 혼자 삼킨 물음이 있거든, 옆자리에서 한 번 더 들어 보시오. <mark>참고 미룬 자리일수록 다른 눈이 먼저 보오.</mark> 오늘은 <b>2명</b>까지요 — 하루에 다 듣는 자리가 아니오.</p>
      {/*

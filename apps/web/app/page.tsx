      ...
      <Shell screen="a1" bare>
        <div className="gatehero" onClick={() => go("a2")}>
          ...
          <div className="gatecopy">
            ...
            <p className="promise">
              그대가 태어난 <b>날</b> 하나면 되오 — 시는 몰라도
              <b>6글자</b>로 보오.<br />
              <b>8글자</b>를 세우고 <b>5마디</b>를 하리다.
  ...
  if (step === "a2") {
    ...
    return (
      <Shell screen="a2" title="이름을 적다" onBack={back}>
        ...
        */}
        <p className="sm mt" style={{ textAlign: "center" }}>
          다음은 <b>날</b>이오. 해·달·날 <b>셋</b>만 적으면
          여덟 글자 중 <b>여섯</b>이 그 자리에서 서오.
        </p>
        {/*
    ...
    return (
      <Shell screen="a4" title="때를 묻다" onBack={back}>
        ...
        */}
        <Meet nameOnly />
        <Say who="도령" lens="pungun">
          때는 아시오? 이 <b>두 글자</b>가 여덟 중 마지막이오.
        </Say>
    ...
    return (
      <Shell screen="a4b" title="성향 4글자" onBack={back}>
        ...
        <Narration lines={["그가 종이 한 장을 더 꺼냈다.",
                           "이번 것은 그가 적은 게 아니었다."]} />
        <Say who="도령" lens="pungun" html="혹시 <b>성향 검사</b>를 해본 적 있소? 그 <b>4글자</b>를 여덟 글자에서 나온 <b>4글자</b>와 맞대 보겠소." />
  ...
  if (step === "a5") {
    ...
    return (
      <Shell screen="a5" title="걸리는 것" onBack={back}>
        ...
        */}
        <Say who="도령" lens="pungun">
          칸은 <b>6개</b>고, 여기서 고른 하나가 뒤의 <b>5마디</b>를 다 바꾸오.
        ...
        */}
        ...
        {s.concernSet && (
          <p className="sm" style={{ textAlign: "center" }}>
            그 자리는 <b>열 자리</b> 가운데 하나인데, 그중 <b>몇이

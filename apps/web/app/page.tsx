      ...
      <Shell screen="a1" bare>
        <div className="gatehero" onClick={() => go("a2")}>
          ...
          <div className="gatecopy">
            ...
            {/*
              ★ 강조를 여섯에서 **하나로** 줄였습니다 (2026-09-04).

                손님이 이 화면을 보며 「글이 너무 많다」고 했습니다.
                그런데 a1 은 스물아홉 화면 중 **가장 짧습니다** —
                253자 · 28초. 읽기속도는 만점이었습니다.

                양이 아니라 **강조**였습니다. 253자에 굵은 글씨가 일곱
                군데(200자당 5.5로 스물아홉 중 최고)였고, 덩이 다섯이
                전부 가운데 정렬에 전부 같은 크기였습니다. 다 굵으면
                아무것도 안 굵습니다 — 눈이 어디부터 볼지 못 정하니
                253자를 다 훑게 되고, 그래서 많게 느껴집니다.

                ★ 글은 **한 자도 안 지웠습니다.** 지우면 당김·팩폭·울림이
                  그 글로 매겨져 있어 점수가 아니라 화면이 상합니다
                  (CLAUDE.md). 표시만 걷었습니다.

                남긴 것은 「0원」 하나 — 이 화면에서 문턱을 치우는 것은
                그 한 마디입니다. 나머지 여섯 글자·다섯 마디는 무엇을
                받는지 세는 말이라 굵지 않아도 읽힙니다.
                이 화면의 주인공은 아래 남긴 물음입니다.
            */}
            <p className="promise">
              그대가 태어난 날 하나면 되오 — 시는 몰라도
              6글자로 보오.<br />
              8글자를 세우고 5마디를 하리다.
              여기까지 값은 <b>0원</b>이오.<br />
              왜 하필 지금 이걸 보고 있는지, 그 자리부터 짚소.
            </p>
            ...
            <ActOut kind="남긴 물음" next="이름을 적다">
              ...
              그건 대문에서 답할 말이 아니오.
              {/*
                ★ 여기 있던 뒤 세 줄을 지웠습니다 (2026-09-04).

                  「8글자를 세우고 마디 5개를 듣는 데 값은 0원이오.
                   때를 모르시면 6글자로 보오.」 — 바로 위 약속이 이미
                  같은 말을 했습니다(여덟 글자 · 다섯 마디 · 값은 안 받소 ·
                  시는 몰라도 되오). 대문에서 같은 사실을 두 번 세면
                  손님은 읽는 게 아니라 훑습니다.

                  대문이 하는 일은 **남긴 물음 하나**입니다.
              */}
              <br />

    ...
    return (
      <Shell screen="c5" title="공유 카드">
        ...
        */}
        ...
        <p className="sm">여태 이런 것을 남에게 보이고 후회한 적이 있거든 안 보내도 되오. 봉하지 않은 편지처럼, 한 번 나가면 도로 거둘 수 없는 것이오.<br />카드에 실리는 것은 <b>8글자</b>에서 나온 셈뿐이고, 생년월일시와 고을은 안 실리오 — 4자리 가운데 나온 것만 담기오. 스무 사람 가운데 지금 읽은 것은 1명이고, 카드 한 장에 드는 시간은 1분이오.</p>
  ...
  if (tab === "c6") {
    return (
      <Shell screen="c6" title="남기다" legal>
        ...
        <p className="sm">그대가 여기까지 읽었소. 여태 참고 미뤄 둔 물음 하나를 오늘 짚은 것이오 — <b>벽에 못 하나 박는 것처럼</b>, 다음에 올 때 걸 데가 생기오. 오늘 남긴 한 줄이 다음에 오는 그대에게 쪽지처럼 놓이는 셈이오.</p>
        {/*
          ★ 여기가 셋째로 낮았습니다 (연출 53).

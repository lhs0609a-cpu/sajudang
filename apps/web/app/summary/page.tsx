    ...
    <Shell screen="c7" title="분석지" legal>
      ...
      {/*
        ★ 여기가 다섯째로 낮았습니다 (연출 55).
          ...
          종이는 다 펴져 있는데 **여는 말이 없었습니다.** 첫 줄이
          곧바로 「성신당 星辰堂」 이라는 표제라, 콜드 오픈이 없고
          누구한테 주는 종이인지도 안 적혀 있었습니다.
          분량도 900자 자리에 332자였습니다 — 값을 치른 사람이
          가져가는 한 장인데 집이 한 마디도 안 얹은 것입니다.

...
- **네 시간 칸을 한복판 시각으로 채우기** — 「한낮 11–15」를 13시로
  적으면 시주가 **절반은 틀립니다** (`.\dev.ps1 hours` — 51.7%).
  시주가 틀리면 여덟 글자 중 둘이 틀리고, 오행 개수가 바뀌어 용신도
  신강약도 달라집니다. 시·분을 **먼저** 묻고 칸은 접어 두세요.
  2026-09-02 에 15시 55분생이 13시로 서서, 없던 불이 생기고 있던
  나무가 사라졌습니다

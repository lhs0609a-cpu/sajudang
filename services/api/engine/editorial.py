...
ROLES={
 ...
 'eunbyeol':('gap_band','자주 쓰는 방법과 잘 안 쓰는 방법','익숙한 방법이 통하지 않을 때도 같은 방법을 더 세게 쓰지는 않소?','늘 쓰던 방법 외에 작게 시험할 방법 하나를 정하시오.'),
 'jeokhyeol':('score_band','맡은 몫과 감당할 수 있는 몫','괜찮다고 한 뒤에야 부담을 느낀 일이 있소?','다음 수락 전에 필요한 시간과 가능한 범위를 적으시오.'),
 'monghwa':('sinsal_mark','관심이 새것으로 옮겨 가는 때','새로운 자극을 찾는 것과 지금의 답답함을 피하는 것을 구분해 보았소?','새로 원하는 것과 지금 피하고 싶은 것을 각각 적으시오.'),
 ...
 'myeonsang':('palace','가까운 사람 앞에서 달라지는 태도','밖에서 보이는 모습과 편한 사람 앞의 모습은 어디서 달라지오?','밖에서와 편한 사람 앞에서 달랐던 반응을 있었던 일만 적어 비교하시오.'),
 ...
 'yeondam':('ilji_state','내가 정할 수 있는 연락과 선','상대의 마음을 추측하느라 내 기준을 미루고 있지는 않소?','상대의 답과 무관하게 지킬 연락 기준을 정하시오.'),
 ...
 'yakcho':('zero_band','일하는 시간과 쉬는 시간 사이의 선','쉬는 시간에도 끝내지 못한 일을 계속 세고 있지는 않소?','오늘 마칠 일과 내일로 미룰 일을 하나씩 구분하시오.'),
...
CONCERNS={
 ...
 'work':('일','최근 맡거나 미룬 업무','내가 맡은 일·걸리는 시간·어디까지 하면 끝인지'),
 'love':('사랑','상대와 말이 어긋났던 대화','실제로 들은 말·내 해석·원하는 요청'),
 'people':('관계','부탁을 받거나 어디까지 해 줄지 선을 그었던 장면','부탁 내용·해 줄 수 있는 만큼·내 일정'),
 'dir':('방향','아직 고르지 못한 두 선택','지킬 것·포기할 것·되돌릴 수 있는 범위'),
 'health':('생활 리듬','하루를 마치는 시간의 습관','마칠 일·미룰 일·쉬기 시작할 시각'),
 'real_estate':('부동산','집·토지·상가를 살 때 목적과 감당할 범위를 먼저 정하는 방식','매수·매도·이사 중 무엇을 결정하려는지와 계약 조건·자금 범위를 분리해서 확인'),
}

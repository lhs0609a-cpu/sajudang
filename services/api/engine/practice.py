...
PRACTICES = {
    ...
    "work": ("잘하는 일과 맡은 일을 구분해보시오",
             "추가 요청 때문에 내 일이 밀렸던 경험이 있다면, 능력보다 담당 범위를 확인해볼 수 있소.",
    ...
    "health": ("오늘의 끝을 작게 정해보시오",
               "쉬는 시간에도 남은 일을 계산하는 경험이 있다면, 하루의 경계를 먼저 정해볼 수 있소.",
    ...
    "dir": ("선택 뒤에 남는 비용을 적어보시오",
            "비교할수록 결정이 어려웠다면, 정보가 부족한지 포기할 것이 부담스러운지 나눠볼 수 있소.",

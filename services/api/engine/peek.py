...
ASK = {
    "daeun_now": "그대의 지금 대운에서는 어떤 주제를 읽소?",
    "yongsin": "그대의 균형을 위해 어떤 기운을 보완하오?",
    "lack": "그대에게 아예 없는 것은",
    "why": "왜 하필 지금 그대인가 하면",
...
ASK_AXIS = {
    ...
    "next_daeun_tg": "그대의 다음 대운에서 달라지는 해석 주제는 무엇이오?",

...
ASK = {
    ...
    "helper": "그대를 돕는 사람이 나타나는 곳은",
    "ancestor": "그대가 집안에서 물려받은 것은",
    "daeun_map": "그대 사주를 읽는 법이 바뀌는 나이는",
    "week": "그대가 이번 주에 하실 한 가지는",
    "closing_cut": "그대가 오늘 하나만 고른다면",
    "chart": "그대의 여덟 글자는",
    "place_now": "지금 그대에게 가장 크게 걸린 일은",
    # 한 줄 · 같은 힘의 앞과 뒤 (engine/spine · 2026-09-11)
    "spine": "그대를 한 줄로 말하면",
    # ★ 「그대로」 를 쓰지 마세요 — 호칭 층이 「그대」 로 읽어 갈아 끼웁니다.
    "spine_depth": "그대의 강점이 곧 약점이 되는 때는",
    # ★ 무료를 넓히면서 엿보기에 올라온 컷들 (2026-09-17).
    #
    #   `ask_of` 는 모르는 컷이면 **제목을 그대로** 씁니다. 그런데
    #   제목은 목차라 손님을 안 부릅니다 — 「일에 걸린 짜임」 이
    #   물음 자리로 나갔습니다 (tests/test_peek 가 잡았습니다).
    #   무료 구성을 바꾸면 이 표도 같이 봐야 하오.
    "concern": "그대가 물은 자리와 사주가 센 자리는",
    "concern_scale": "그대가 물은 자리를 저울에 올리면",
    "concern_pattern": "그대가 물은 자리에 걸린 짜임은",
    "concern_turn": "그대가 물은 자리에서 판이 바뀌는 때는",
    "concern_face": "그대가 물은 자리에서 드러나는 얼굴은",
    "solace": "그대 탓이 아닌 자리는",
    "hope": "그대가 이미 쥐고 있는 것은",
    "hindsight": "그대가 이미 지나온 자리는",
    "counter": "이 말이 틀렸다면 어디서 틀렸겠소",
    "lens_bridge": "이 사람이 그대에게서 먼저 보는 것은",
    "spine_scene": "그대가 그 자리에 서면 벌어지는 일은",
}
...
ASK_AXIS = {
    "deuk": "그대가 혼자 버틸 힘과 도움받을 여건은 어떻소?",
    "top_ten_god": "그대를 앞에서 끌고 가는 성격은",
    "daeun_phase": "그대가 지금 십 년 가운데 어디쯤 와 있는가는",
    "daeun_ten_god": "지금 대운이 그대에게 시키는 것은",
    "next_daeun_tg": "그대의 다음 대운에서는 무엇이 달라지오?",
    "year_ji": "그대가 고른 적 없이 물려받은 것은",
    "month_ji": "그대가 태어난 계절이 정해 준 것은",
    "ilji_state": "그대와 가장 가까운 사람 사이는",
    "score_band": "그대가 버티는 힘의 강약을 어떤 근거로 읽소?",
    "strength": "그대가 주도할 때와 도움받을 때를 어떻게 읽소?",
    "weak_el": "그대에게 가장 모자란 것은 무엇이오?",
    "strong_el": "그대에게 넘치는 것은",
    "yongsin": "그대에게 있어야 할 것은",
    "zero_band": "그대 여덟 글자에 하나도 없는 것은",
    "gap_band": "그대 사주가 한쪽으로 얼마나 쏠렸는가는",
    "flow": "그대는 힘을 주로 어디에 쓰오?",
    "gwan_jae": "그대 사주에서 일과 돈을 보는 글자는 몇 개요?",
    "age_band": "지금 그대 나이에 맞는 풀이는",
    "season": "그대가 태어난 계절은",
    "johu": "그대의 여덟 글자가 추운지 더운지는",
    "seupjo": "그대의 여덟 글자가 젖었는지 말랐는지는",
    "sinsal_mark": "그대 사주에 붙은 옛 이름표는",
    "palace": "그대 네 기둥 가운데 가장 힘이 실린 곳은",
    "hour_known": "그대 태어난 시각을 알면 달라지는 것은",
}
...
def _wants_spec(f) -> list:
    ...
    if left and nxt:
        out.append((
            "운명",
            "십 년마다 바뀌는 때가 <b>%d번</b> 남았고, 다음은 <b>%d세</b>요." % (left, nxt),
            ["daeun_map", "daeun_now", "_turn", "_age"]))
    if n_ss:
        out.append((
            "사람",
            "그대 사주에 옛사람이 <b>이름을 붙여 둔 곳</b>이 <b>%d개</b> 있소." % n_ss,

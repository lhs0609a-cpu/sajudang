...
#   곧 아무도 안 보는 검사가 됩니다.
#
#   目標  19,900:8  15,900:6  12,900:4  9,900:3  6,900:2  4,900:1
#   지금  19,900 · 15,900 까지 올렸습니다. 남은 등급은
#         `.\dev.ps1 ladder` 가 캐릭터마다 세어 줍니다.
OWN_FLOOR = ((19900, 8), (15900, 6), (12900, 0), (9900, 0),
             (6900, 0), (4900, 0), (0, 0))

# 아직 못 채운 등급 — 여기가 비면 값 사다리가 다 선 것입니다.
OWN_TARGET = ((19900, 8), (15900, 6), (12900, 4), (9900, 3),
              (6900, 2), (4900, 1), (0, 0))
